...
class Test
{
	...
	static int dp[][] = new int[1025][101]; // If 2 bits are there then 4 mask(00,01,10,11) combinations are possible
	...
	static void countWays(int n) throws Exception
	{
		...
		allmask = (1 << n) - 1; //moves 1 by n times if 1<<3 then 100-means value is 8 now
